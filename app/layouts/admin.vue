...
const groups = [
  { label: 'GESTIÓN', items: [{ label: 'Contenido', icon: '✎', to: '/admin/publicaciones' }, { label: 'Pedidos', icon: '▤', to: '/admin/pedidos' }, { label: 'Clientes', icon: '♙', to: '/admin/clientes' }, { label: 'Reseñas', icon: '★', to: '/admin/resenas' }] },
